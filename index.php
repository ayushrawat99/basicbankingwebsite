...
<p> <h3> About Us</h3> </br> </br> <i> Z Bank offers the  financial transactions to be completed hastily between 2 Accounts. Our organisation helps to make banking easy and accessible for everyone. </br> With Z bank, You can send your money to anyone anywhere in this world in seconds.
      </i></p>
 </div>
...
<section class= "my-5">
<div class="text-center py-5">
<p> <strong> Disclaimer </strong> </br>This website is an Intern project.</p>
 </div>

</div>

<footer class="text-center mt-2 py-5">
        <p>&copy 2021  <b>Ayush Rawat</b> </br>All rights reserved</p>
      </footer>
